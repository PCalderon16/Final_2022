...
The chi-squared test provided a small p-value of 0 which means that results expected by the null hypothesis are unlikely to happen by chance. This also implies there is a correlation between the type of treatment and contraction of covid-19 among males, or that there is a statistical difference in the effect of the placebo and the vaccine among males in preventing covid-19 infection.  Moreover, according to the odds ratio provided in the fisher's exact test, males who took the placebo are 2 times more likely to contract covid-19 than those who took the vaccine.  
